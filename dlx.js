...
function dlx(vplayer) {
	...
	function showALUForwarding(opacity) {
		if (opacity==0) {
			...
			$g[142].setPoint(0, 1136, 485)
			$g[142].setPoint(1, 1271, 485)
			$g[143].setPoint(0, 1136, 529)
			$g[143].setPoint(1, 1271, 529)
			$g[144].setPoint(2, 1163, 551)
			$g[144].setPoint(3, 1271, 551)
			$g[142].setHead(1)
		}
	...
	function showSMDRForwarding(opacity) {
		if (opacity==0) {
			$g[150].setPoint(1, 1109, 727)
			$g[150].setPoint(2, 1298, 727)
			$g[150].setHead(0)
		} else {
			$g[150].setPoint(1, 1109, 749)
			$g[150].setPoint(2, 1271, 749)
			$g[150].setHead(1)
		}
	...
	function showZeroForwarding(opacity) {
		if (opacity==0) {
			$g[107].setPt(1, 960, 298)
			$g[107].setPt(2, 960, 353)
		} else {
			$g[107].setPt(1, 933, 298)
			$g[107].setPt(2, 933, 353)
		}
	...
	function showPipeline(opacity) {
		if (opacity==0) {
			$g[90].setPoint(1, 703, 507)
			$g[90].setPoint(2, 703, 529)
			$g[113].setPoint(0, 703, 507)
			$g[114].setPoint(0, 703, 507)
			$g[92].setPoint(1, 1136, 860)
			$g[130].setPoint(1, 1001, 452)
			$g[130].setPoint(2, 1136, 452)
			$g[127].setPoint(1, 1109, 551)
			$g[150].setPoint(0, 1109, 551)
			$g[152].setPoint(3, 1568, 507)
			$g[153].setPoint(3, 1568, 507)
			$g[151].setPoint(1, 1595, 727)
			$g[161].setPoint(1, 1839, 507)
			$g[92].setHead(0)
			$g[90].setHead(0)
			$g[130].setHead(0)
			$g[142].setHead(0)
			...
			$g[90].setPoint(1, 649, 507)
			$g[90].setPoint(2, 676, 507)
			$g[113].setPoint(0, 703, 551)
			$g[114].setPoint(0, 703, 551)
			$g[92].setPoint(1, 1082, 860)
			$g[130].setPoint(1, 1001, 463)
			$g[130].setPoint(2, 1082, 463)
			$g[127].setPoint(1, 1082, 551)
			$g[150].setPoint(0, 1109, 595)
			$g[152].setPoint(3, 1514, 507)
			$g[153].setPoint(3, 1514, 507)
			$g[151].setPoint(1, 1487, 727)
			$g[161].setPoint(1, 1785, 507)
			$g[92].setHead(1)
			$g[90].setHead(1)
			$g[130].setHead(1)
			$g[142].setHead(1)
	...
	function execute(thread) {
		...
		while (1) {
			...
			case 1:
				...
				$g[51] = new Rectangle2($g[0], 0, HLEFT, 0, new SolidBrush(DARK_BLUE), 27, 27, 811, 66, $g[4], $g[50], sprintf(" MIPS Animation %s", $g[49]))
				...
				$g[81] = new Rectangle($g[0], $g[19], 0, 0, $g[11], 487, 8130, -81, -13, 130, 26, $g[4], $g[15])
				$g[81].setRounded(2, 2)
				$g[82] = new AnimPipe()
				...
				$g[117] = new Rectangle($g[0], $g[19], 0, 0, $g[11], 8135, 829, -32, -13, 65, 32, $g[4], $g[15])
				$g[117].setRounded(2, 2)
				$g[118] = new AnimPipe()
				$g[118].addPoint(771, 595)
				$g[118].addPoint(771, 397)
				$g[119] = new Rectangle($g[0], $g[19], 0, 0, $g[11], 771, 441, -32, -13, 65, 32, $g[4], $g[15])
				$g[119].setRounded(2, 2)
				$g[120] = new AnimPipe()
				$g[120].addPoint(852, 595)
				$g[120].addPoint(852, 397)
				$g[121] = new Rectangle($g[0], $g[19], 0, 0, $g[11], 852, 441, -32, -13, 65, 32, $g[4], $g[15])
				$g[121].setRounded(2, 2)
				$g[122] = new AnimPipe()
				$g[122].addPoint(811, 375)
				$g[122].addPoint(811, 287)
				$g[122].addPoint(703, 287)
				$g[123] = new Rectangle($g[0], $g[19], 0, 0, $g[11], 811, 353, -32, -13, 65, 32, $g[4], $g[15])
				...
				$g[126] = new Rectangle($g[0], $g[19], 0, 0, $g[11], 811, 97, -32, 0, 65, 32, $g[4], $g[15])
				$g[127] = new AnimPipe()
				...
				$g[129] = new Rectangle($g[0], $g[19], 0, 0, $g[11], 919, 181, -32, 0, 65, 32, $g[4], $g[15], "R0:0")
				$g[129].setRounded(2, 2)
				$g[130] = new AnimPipe()
				$g[130].addPoint(1001, 154)
				$g[130].addPoint(1001, 463)
				$g[130].addPoint(1082, 463)
				$g[131] = new Rectangle($g[0], $g[19], 0, 0, $g[11], 1001, 181, -32, 0, 65, 32, $g[4], $g[15], "R0:0")
				...
				$g[145] = new Rectangle($g[0], $g[19], 0, 0, $g[11], 1168, 816, -27, 0, 54, 26, $g[4], $g[15], "IMM")
